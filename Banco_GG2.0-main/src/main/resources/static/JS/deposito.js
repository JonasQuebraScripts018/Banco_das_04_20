$("#enviarDeposito").click(validaEnvioDeposito);
...
function validaEnvioDeposito(){
    ...
    let valorDesposito = $("#valorDeposito").val();

    if(validaCampoVazio(dinheiro)){
        podeEnviar = false;
    }
    if(validaCampoVazio(valorDesposito)){
        podeEnviar = false;
    }
    if(podeEnviar){
        $.ajax({
            ...
            data:{
                dinheiro:dinheiro,
                valorDesposito:valorDesposito,
            },
            success: function (data){
                if(data.sucesso){
                    alert("Deu bom, mas agr vc ficou um pouco probre!");
                }else{
                    alert(data);
                }
            },
